...
var pvrWriteCopyrights = function () {
    ...
    mainApplication = function () {
        jQuery(document).ready(function (a) {
			...
			var l2 = document.querySelector(".ui-range-slider2");
            if (void 0 !== l2 && null !== l2) {
                var m2 = parseInt(l2.parentNode.getAttribute("data-start-min"), 10),
                    n2 = parseInt(l2.parentNode.getAttribute("data-start-max"), 10),
                    o2 = parseInt(l2.parentNode.getAttribute("data-min"), 10),
                    p2 = parseInt(l2.parentNode.getAttribute("data-max"), 10),
                    q2 = parseInt(l2.parentNode.getAttribute("data-step"), 10),
                    r2 = document.querySelector(".ui-range-value-min2 span"),
                    s2 = document.querySelector(".ui-range-value-max2 span"),
                    t2 = document.querySelector(".ui-range-value-min2 input"),
                    u2 = document.querySelector(".ui-range-value-max2 input");
                noUiSlider.create(l2, {
                    start  : [ m2, n2 ],
                    connect: !0,
                    step   : q2,
                    range  : {min: o2, max: p2}
                }), l2.noUiSlider.on("update", function (a, b) {
                    var c = a[ b ];
                    b ? (s2.innerHTML = Math.round(c), u2.value = Math.round(c)) : (r2.innerHTML = Math.round(c), t2.value = Math.round(c))
                })
            }
